...
namespace DianDang
{
    ...
    public partial class DDPawnageInfoController
    {
	    ...
	    public void Insert(int? ClassID,int? ParentID,int? StatusID,string CountNumber,string Weight,string Price,string FeeRate,string InterestRate,string DiscountPercent,string Description,string Remark,string StartDate,string EndDate)
	    {
	    ...
	    public void Update(int PawnageID,int? ClassID,int? ParentID,int? StatusID,string CountNumber,string Weight,string Price,string FeeRate,string InterestRate,string DiscountPercent,string Description,string Remark,string StartDate,string EndDate)
	    {
		    DDPawnageInfo item = new DDPawnageInfo();
	        item.MarkOld();
	        item.IsLoaded = true;
