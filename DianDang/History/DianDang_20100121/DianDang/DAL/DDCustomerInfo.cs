...
namespace DianDang
{
	...
	public partial class DDCustomerInfo : ActiveRecord<DDCustomerInfo>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varCustomerName,string varPhoneNumber,string varAddress,string varContactPerson,int? varCertTypeID,string varCertNumber)
		{
		...
		/// </summary>
		public static void Update(int varCustomerID,string varCustomerName,string varPhoneNumber,string varAddress,string varContactPerson,int? varCertTypeID,string varCertNumber)
		{
			DDCustomerInfo item = new DDCustomerInfo();
