	...
	public partial class DDPawnageInfo : ActiveRecord<DDPawnageInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarPhotoPath.DataType = DbType.AnsiString;
				colvarPhotoPath.MaxLength = -1;
		...
		public double Price 
		{
			get { return GetColumnValue<double>(Columns.Price); }
		...
		/// </summary>
		public static void Insert(int? varClassID,int? varParentID,int? varStatusID,string varCountNumber,string varWeight,double varPrice,string varFeeRate,string varInterestRate,string varDiscountPercent,string varDescription,string varRemark,string varStartDate,string varEndDate,string varPhotoPath)
		{
		...
		/// </summary>
		public static void Update(int varPawnageID,int? varClassID,int? varParentID,int? varStatusID,string varCountNumber,string varWeight,double varPrice,string varFeeRate,string varInterestRate,string varDiscountPercent,string varDescription,string varRemark,string varStartDate,string varEndDate,string varPhotoPath)
		{
			DDPawnageInfo item = new DDPawnageInfo();
