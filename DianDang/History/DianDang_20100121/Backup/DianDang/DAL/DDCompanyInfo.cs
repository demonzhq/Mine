...
namespace DianDang
{
	...
	public partial class DDCompanyInfo : ActiveRecord<DDCompanyInfo>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varCompanyName,string varAmountAccuracy, string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varStartTicketNumber,string varSetupDate)
		{
		...
		/// </summary>
		public static void Update(int varCompanyID,string varCompanyName, string varAmountAccuracy, string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varStartTicketNumber,string varSetupDate)
		{
			DDCompanyInfo item = new DDCompanyInfo();
