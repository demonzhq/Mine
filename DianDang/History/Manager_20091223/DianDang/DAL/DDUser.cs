...
namespace DianDang
{
	...
	public partial class DDUser : ActiveRecord<DDUser>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varAccountName,string varUserPassword,string varUserName,int? varRoleID,string varEmail,string varPhoneNumber,string varCertNumber)
		{
		...
		/// </summary>
		public static void Update(int varUserID,string varAccountName,string varUserPassword,string varUserName,int? varRoleID,string varEmail,string varPhoneNumber,string varCertNumber)
		{
			DDUser item = new DDUser();
