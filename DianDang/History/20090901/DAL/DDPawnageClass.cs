...
namespace DianDang
{
	...
	public partial class DDPawnageClass : ActiveRecord<DDPawnageClass>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varClassName,int? varParentID,int? varUnitID,string varMonthFeeRate,string varInterestRate,string varDescription)
		{
		...
		/// </summary>
		public static void Update(int varClassID,string varClassName,int? varParentID,int? varUnitID,string varMonthFeeRate,string varInterestRate,string varDescription)
		{
			DDPawnageClass item = new DDPawnageClass();
