	...
	public partial class DDCompanyInfo : ActiveRecord<DDCompanyInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarRemark.MaxLength = 2147483647;
		...
		/// </summary>
		public static void Insert(string varCompanyName,string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varRemark)
		{
		...
		/// </summary>
		public static void Update(int varCompanyID,string varCompanyName,string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varRemark)
		{
			DDCompanyInfo item = new DDCompanyInfo();
