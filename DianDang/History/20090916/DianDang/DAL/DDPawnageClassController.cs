...
namespace DianDang
{
    ...
    public partial class DDPawnageClassController
    {
	    ...
	    public void Insert(string ClassName,int? ParentID,int? UnitID,string MonthFeeRate,string InterestRate,string Description,int? IsRoot,int? StatisticClassID)
	    {
	    ...
	    public void Update(int ClassID,string ClassName,int? ParentID,int? UnitID,string MonthFeeRate,string InterestRate,string Description,int? IsRoot,int? StatisticClassID)
	    {
		    DDPawnageClass item = new DDPawnageClass();
	        item.MarkOld();
	        item.IsLoaded = true;
