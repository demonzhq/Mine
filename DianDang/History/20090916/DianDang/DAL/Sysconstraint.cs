...
namespace DianDang{
    ...
    /// </summary>
    [Serializable]
    public partial class Sysconstraint : ReadOnlyRecord<Sysconstraint>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("sysconstraints", TableType.View, DataService.GetInstance("DianDang"));
                ...
                DataService.Providers["DianDang"].AddSchema("sysconstraints",schema);
            }
        }
        #endregion
