...
namespace DianDang{
    ...
    /// </summary>
    [Serializable]
    public partial class Syssegment : ReadOnlyRecord<Syssegment>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("syssegments", TableType.View, DataService.GetInstance("DianDang"));
                ...
                DataService.Providers["DianDang"].AddSchema("syssegments",schema);
            }
        }
        #endregion
