	...
	public partial class DDPawnageClass : ActiveRecord<DDPawnageClass>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				TableSchema.TableColumn colvarMaxFeeRate = new TableSchema.TableColumn(schema);
				colvarMaxFeeRate.ColumnName = "MaxFeeRate";
				colvarMaxFeeRate.DataType = DbType.AnsiString;
				colvarMaxFeeRate.MaxLength = 50;
				colvarMaxFeeRate.AutoIncrement = false;
				colvarMaxFeeRate.IsNullable = true;
				colvarMaxFeeRate.IsPrimaryKey = false;
				colvarMaxFeeRate.IsForeignKey = false;
				colvarMaxFeeRate.IsReadOnly = false;
				colvarMaxFeeRate.DefaultSetting = @"";
				colvarMaxFeeRate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMaxFeeRate);
				
				TableSchema.TableColumn colvarMinFeeRate = new TableSchema.TableColumn(schema);
				colvarMinFeeRate.ColumnName = "MinFeeRate";
				colvarMinFeeRate.DataType = DbType.AnsiString;
				colvarMinFeeRate.MaxLength = 50;
				colvarMinFeeRate.AutoIncrement = false;
				colvarMinFeeRate.IsNullable = true;
				colvarMinFeeRate.IsPrimaryKey = false;
				colvarMinFeeRate.IsForeignKey = false;
				colvarMinFeeRate.IsReadOnly = false;
				colvarMinFeeRate.DefaultSetting = @"";
				colvarMinFeeRate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMinFeeRate);
		...
		[XmlAttribute("MaxFeeRate")]
		[Bindable(true)]
		public string MaxFeeRate 
		{
			get { return GetColumnValue<string>(Columns.MaxFeeRate); }
			set { SetColumnValue(Columns.MaxFeeRate, value); }
		}
		  
		[XmlAttribute("MinFeeRate")]
		[Bindable(true)]
		public string MinFeeRate 
		{
			get { return GetColumnValue<string>(Columns.MinFeeRate); }
			set { SetColumnValue(Columns.MinFeeRate, value); }
		}
		...
		/// </summary>
		public static void Insert(string varClassName,int? varParentID,int? varUnitID,string varMonthFeeRate,string varMaxFeeRate,string varMinFeeRate,string varInterestRate,string varDescription,int? varIsRoot,int? varStatisticClassID)
		{
			...
			item.MaxFeeRate = varMaxFeeRate;
			
			item.MinFeeRate = varMinFeeRate;
		...
		/// </summary>
		public static void Update(int varClassID,string varClassName,int? varParentID,int? varUnitID,string varMonthFeeRate,string varMaxFeeRate,string varMinFeeRate,string varInterestRate,string varDescription,int? varIsRoot,int? varStatisticClassID)
		{
			DDPawnageClass item = new DDPawnageClass();
        ...
        public static TableSchema.TableColumn MaxFeeRateColumn
        {
        ...
        public static TableSchema.TableColumn MinFeeRateColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string MaxFeeRate = @"MaxFeeRate";
			 public static string MinFeeRate = @"MinFeeRate";
