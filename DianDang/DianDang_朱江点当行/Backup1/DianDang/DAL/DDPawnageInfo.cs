...
namespace DianDang
{
	...
	public partial class DDPawnageInfo : ActiveRecord<DDPawnageInfo>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int? varClassID,int? varParentID,int? varStatusID,string varCountNumber,string varWeight,string varPrice,string varFeeRate,string varInterestRate,string varDiscountPercent,string varDescription,string varRemark,string varStartDate,string varEndDate,string varPhotoPath)
		{
		...
		/// </summary>
		public static void Update(int varPawnageID,int? varClassID,int? varParentID,int? varStatusID,string varCountNumber,string varWeight,string varPrice,string varFeeRate,string varInterestRate,string varDiscountPercent,string varDescription,string varRemark,string varStartDate,string varEndDate,string varPhotoPath)
		{
			DDPawnageInfo item = new DDPawnageInfo();
