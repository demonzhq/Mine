...
namespace DianDang
{
    public partial class QueryByClassForm : DockContent
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            excelDoc = excelApp.Workbooks._Open(Application.StartupPath + @"\Pram\QueryByClass.dd", Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
            ...
            //打印标题
            string Title = "";
            Title = Title + "起始时间：" + this.tbxStartDate.Text + "    ";
            Title = Title + "结束时间：" + this.tbxEndDate.Text + "    ";
            Title = Title + "查询人：" + new DDUser("AccountName", MainForm.AccountName).UserName;
            ...
            //第一段Title
            int ExcelRow = 2;
            r = ws.get_Range("B" + ExcelRow, "B" + ExcelRow); r.Value2 = "（1）期初在当";
            r = ws.get_Range("E" + ExcelRow, "E" + ExcelRow); r.Value2 = "（2）期初未清";
            r = ws.get_Range("H" + ExcelRow, "H" + ExcelRow); r.Value2 = "（3）期内已清";

            ExcelRow++;

            r = ws.get_Range("A" + ExcelRow, "A" + ExcelRow); r.Value2 = "当品类别";
            r = ws.get_Range("B" + ExcelRow, "B" + ExcelRow); r.Value2 = "件数";
            r = ws.get_Range("C" + ExcelRow, "C" + ExcelRow); r.Value2 = "重量";
            r = ws.get_Range("D" + ExcelRow, "D" + ExcelRow); r.Value2 = "金额";
            r = ws.get_Range("E" + ExcelRow, "E" + ExcelRow); r.Value2 = "件数";
            r = ws.get_Range("F" + ExcelRow, "F" + ExcelRow); r.Value2 = "重量";
            r = ws.get_Range("G" + ExcelRow, "G" + ExcelRow); r.Value2 = "金额";
            r = ws.get_Range("H" + ExcelRow, "H" + ExcelRow); r.Value2 = "件数";
            r = ws.get_Range("I" + ExcelRow, "I" + ExcelRow); r.Value2 = "重量";
            r = ws.get_Range("J" + ExcelRow, "J" + ExcelRow); r.Value2 = "金额";
            ...
            //第二段
            //第二段Title
            r = ws.get_Range("B" + ExcelRow, "B" + ExcelRow); r.Value2 = "（4）期内新建";
            r = ws.get_Range("E" + ExcelRow, "E" + ExcelRow); r.Value2 = "（5）期内赎当";
            r = ws.get_Range("H" + ExcelRow, "H" + ExcelRow); r.Value2 = "（6）期内续当";
            ...
            //第三段
            //第三段Title
            r = ws.get_Range("B" + ExcelRow, "B" + ExcelRow); r.Value2 = "（7）期内绝当";
            r = ws.get_Range("E" + ExcelRow, "E" + ExcelRow); r.Value2 = "（8）期末在期";
            r = ws.get_Range("H" + ExcelRow, "H" + ExcelRow); r.Value2 = "（9）期末过期";
            ...
            //第四段
            //第四段Title
            r = ws.get_Range("B" + ExcelRow, "B" + ExcelRow); r.Value2 = "（10）期末在当";
            r = ws.get_Range("E" + ExcelRow, "E" + ExcelRow); r.Value2 = "（11）期末未清";
            r = ws.get_Range("H" + ExcelRow, "H" + ExcelRow); r.Value2 = "（12）期末库存";
