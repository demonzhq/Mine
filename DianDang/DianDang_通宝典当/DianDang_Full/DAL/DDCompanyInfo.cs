	...
	public partial class DDCompanyInfo : ActiveRecord<DDCompanyInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
                ...
                TableSchema.TableColumn colvarAmountAccuracy = new TableSchema.TableColumn(schema);
                colvarAmountAccuracy.ColumnName = "AmountAccuracy";
                colvarAmountAccuracy.DataType = DbType.Int32;
                colvarAmountAccuracy.AutoIncrement = false;
                colvarAmountAccuracy.IsNullable = true;
                colvarAmountAccuracy.IsPrimaryKey = false;
                colvarAmountAccuracy.IsForeignKey = false;
                colvarAmountAccuracy.IsReadOnly = false;
                colvarAmountAccuracy.DefaultSetting = @"";
                colvarAmountAccuracy.ForeignKeyTableName = "";
                schema.Columns.Add(colvarAmountAccuracy);
                ...
                TableSchema.TableColumn colvarCountDayMode = new TableSchema.TableColumn(schema);
                colvarCountDayMode.ColumnName = "CountDayMode";
                colvarCountDayMode.DataType = DbType.Int32;
                colvarCountDayMode.MaxLength = 50;
                colvarCountDayMode.AutoIncrement = false;
                colvarCountDayMode.IsNullable = true;
                colvarCountDayMode.IsPrimaryKey = false;
                colvarCountDayMode.IsForeignKey = false;
                colvarCountDayMode.IsReadOnly = false;
                colvarCountDayMode.DefaultSetting = @"";
                colvarCountDayMode.ForeignKeyTableName = "";
                schema.Columns.Add(colvarCountDayMode);
        ...
        [XmlAttribute("AmountAccuracy")]
        [Bindable(true)]
        public string AmountAccuracy
        {
            get { return GetColumnValue<string>(Columns.AmountAccuracy); }
            set { SetColumnValue(Columns.AmountAccuracy, value); }
        }
        ...
        [XmlAttribute("CountDayMode")]
        [Bindable(true)]
        public int CountDayMode
        {
            get { return GetColumnValue<int>(Columns.CountDayMode); }
            set { SetColumnValue(Columns.CountDayMode, value); }
        }
		...
		/// </summary>
		public static void Insert(string varCompanyName,string varAmountAccuracy, string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varStartTicketNumber,string varSetupDate, int varCountDayMode)
		{
			DDCompanyInfo item = new DDCompanyInfo();
			
			item.CompanyName = varCompanyName;

            item.AmountAccuracy = varAmountAccuracy;
            ...
            item.CountDayMode = varCountDayMode;
		...
		/// </summary>
		public static void Update(int varCompanyID,string varCompanyName, string varAmountAccuracy, string varPhoneNumber,string varLicenseCode,string varAddress,string varSubCompanyNumber,string varSubCompanyName,string varPostalcode,string varShopHours,string varStartTicketNumber,string varSetupDate,int varCountDayMode)
		{
			DDCompanyInfo item = new DDCompanyInfo();
        ...
        public static TableSchema.TableColumn AmountAccuracyColumn
        {
        ...
        public static TableSchema.TableColumn CountDayModeColumn
        {
		...
		public struct Columns
		{
             ...
             public static string AmountAccuracy = @"AmountAccuracy";
             ...
             public static string CountDayMode = @"CountDayMode";			
		}
		#endregion
